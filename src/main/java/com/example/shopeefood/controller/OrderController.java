...
public class OrderController {
    ...
    @GetMapping("/ordersMerchant/{idShop}")
    public ResponseEntity<List<OrderItem>> getOrderMerchantByIdShop(@PathVariable Long idShop) {
        Optional<Shop> shop = iShopService.findById(idShop);
        List<OrderItem> orderItems = (List<OrderItem>) iOrderItemService.findOrderItemByShop(shop.get());
